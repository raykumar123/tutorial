...
////DELETE USER DETAILS USING NETWORK CALL VIA AXIOS
...
function showUserOnScreen(obj){
   ...
   childElem.textContent=obj.expense + ' - ' + obj._id + ' -  ' +obj.description + ' - '
  ...
  const editButton =document.createElement('input')
   ...
   editButton.onclick =() => {
    ...
    document.getElementById('emailInputTag').value = obj._id
